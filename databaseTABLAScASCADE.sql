...
INSERT INTO exercises (nombre, tipo, descripcion, url) values ('Sentadilla isométrica','musculacion', 'Apoya tu espalda en la pared, flexiona las rodillas y mantén la posición unos segundos, así de fácil. Las sentadillas isométricas son ideales para ganar fuerza en los cuádriceps,', 'jW9_hb74wNs');
INSERT INTO exercises (nombre, tipo, descripcion, url) values ('Salto de comba','cardio', 'Saltar a la comba es un ejercicio que requiere coordinación de movimientos, equilibrio, fuerza y resistencia. Es una manera muy eficaz de hacer ejercicio intenso', 'jW9_hb74wNs');
INSERT INTO exercises (nombre, tipo, descripcion, url) values ('Jumping Jacks','cardio', 'Es un ejercicio en el que, estando de pie, hay que saltar y separar las piernas a la vez que das una palmada sobre la cabeza, para después volver a saltar y unir las piernas, volviendo a dejar las manos abajo, a lo largo del cuerpo.', 'jW9_hb74wNs');
INSERT INTO exercises (nombre, tipo, descripcion, url) values ('Burpees','cardio', 'Se parte de posición de pie, te agachas, te tiras al suelo haciendo una flexión de brazos, desde esa posición te reincorporas, te pones de pie, y das un salto vertical', 'jW9_hb74wNs');
INSERT INTO exercises (nombre, tipo, descripcion, url) values ('Mountain climbers','cardio', 'La posición de partida es con ambas manos apoyadas en el suelo, separadas la anchura de los hombros, y manteniendo los codos rectos. Las piernas se colocan una extendida y otra flexionada, apoyando las puntas de los pies en el suelo. Acercamos de forma alternativa las rodillas al pecho, haciendo un movimiento similar a como si estuviéramos corriendo, o más bien escalando.', 'jW9_hb74wNs');
INSERT INTO exercises (nombre, tipo, descripcion, url) values ('Salto con las rodillas al pecho','cardio', 'Permaneciendo de pie, con las piernas separadas a la anchura de los hombros, se da un salto, elevando las rodillas como si quisiéramos llevarlas al pecho.', 'jW9_hb74wNs');
INSERT INTO exercises (nombre, tipo, descripcion, url) values ('Cuello ','estiramiento', 'De pie con  la espalda recta y las manos entrelazadas por detrás de la nuca. Tira de la cabeza hacia abajo, sin encorvar el tronco, hasta que la barbilla toque el pecho.', 'jW9_hb74wNs');
INSERT INTO exercises (nombre, tipo, descripcion, url) values ('Deltoides','estiramiento', 'Ponte de pie con la espalda recta. Pasa un brazo por detrás de la espalda sujétalo con la mano contraria por la  muñeca y tira de ella. En esa posición ladea la cabeza todo lo que puedas hacia el mismo lado hacia el que estás tirando del brazo. Notarás una gran tensión un lado de tu cuello.', 'jW9_hb74wNs');
INSERT INTO exercises (nombre, tipo, descripcion, url) values ('Hombros','estiramiento', 'De pie pasa el brazo por delante del hombro contrario, y con la otra mano presionas sobre el brazo haciendo así el estiramiento.', 'jW9_hb74wNs');
INSERT INTO exercises (nombre, tipo, descripcion, url) values ('Tríceps','estiramiento', 'De pie con los brazos sobre la cabeza, se sostiene un codo con la mano del otro brazo. Lentamente, tiraremos el codo hacia la nuca.', 'jW9_hb74wNs');
INSERT INTO exercises (nombre, tipo, descripcion, url) values ('Muñeca y antebrazo','estiramiento', 'A cuatro patas y con los brazos estirados con las manos mirando hacia las rodillas, ir tirando poco a poco hacia atrás, para ir notando tensión poco a poco en las muñecas y antebrazos.', 'jW9_hb74wNs');
INSERT INTO exercises (nombre, tipo, descripcion, url) values ('Dorsales','estiramiento', 'De pie con los brazos sobre la cabeza, se sostiene un codo con la mano del otro brazo. Lentamente inclinamos el tronco hacia el lado contrario al que sujetas el codo.', 'jW9_hb74wNs');
INSERT INTO exercises (nombre, tipo, descripcion, url) values ('Glúteo','estiramiento', 'Túmbate en el suelo con los brazos en cruz, flexiona una pierna y gira la cadera sin separar los hombros del suelo hasta que tu rodilla flexionada toque el suelo.', 'jW9_hb74wNs');
INSERT INTO exercises (nombre, tipo, descripcion, url) values ('Cuádriceps','estiramiento', 'De pie, coge un pie con las manos por detrás de la espalda e intenta tocar con el talón en el glúteo. Puedes apoyarte en la pared para tener mejor equilibrio.', 'jW9_hb74wNs');
INSERT INTO exercises (nombre, tipo, descripcion, url) values ('Isquiotibiales','estiramiento', 'De pie, flexiona el tronco hacia adelante para tocar la punta de los pies. Evita doblar las rodillas.', 'jW9_hb74wNs');

INSERT INTO tables (nombre, tipo, descripcion) values ('Aumento de volumen', 'estandar', 'En cada uno de los siguientes ejercicios, deberemos dejar únicamente 1 minuto de descanso entre serie y serie. Porque, buscamos dejar poco tiempo de recuperación para poder quemar una mayor cantidad de calorías. Así que, es importante que respetemos los tiempos de descanso.');
INSERT INTO tables (nombre, tipo, descripcion) values ('Aumento de volumen', 'estandar', 'En cada uno de los siguientes ejercicios, deberemos dejar únicamente 1 minuto de descanso entre serie y serie. Porque, buscamos dejar poco tiempo de recuperación para poder quemar una mayor cantidad de calorías. Así que, es importante que respetemos los tiempos de descanso.');
INSERT INTO tables (nombre, tipo, descripcion) values ('Aumento de volumen', 'estandar', 'En cada uno de los siguientes ejercicios, deberemos dejar únicamente 1 minuto de descanso entre serie y serie. Porque, buscamos dejar poco tiempo de recuperación para poder quemar una mayor cantidad de calorías. Así que, es importante que respetemos los tiempos de descanso.');
INSERT INTO tables (nombre, tipo, descripcion) values ('Aumento de volumen', 'estandar', 'En cada uno de los siguientes ejercicios, deberemos dejar únicamente 1 minuto de descanso entre serie y serie. Porque, buscamos dejar poco tiempo de recuperación para poder quemar una mayor cantidad de calorías. Así que, es importante que respetemos los tiempos de descanso.');
INSERT INTO tables (nombre, tipo, descripcion) values ('Aumento de volumen', 'estandar', 'En cada uno de los siguientes ejercicios, deberemos dejar únicamente 1 minuto de descanso entre serie y serie. Porque, buscamos dejar poco tiempo de recuperación para poder quemar una mayor cantidad de calorías. Así que, es importante que respetemos los tiempos de descanso.');
