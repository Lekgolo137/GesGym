...
?>
			...
			<?=i18n("Description")?>:
			<input disabled type="text" class="form-control" placeholder="<?=i18n("Description")?>" value="<?=$exercise->getDescripcion()?>">
			<?=i18n("URL")?>:
			<input disabled type="text" class="form-control" placeholder="<?=i18n("URL")?>" value="<?=$exercise->getUrl()?>">
