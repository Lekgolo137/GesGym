...
<?php foreach ($exercises as $exercise): ?>
							<tr>
								...
								<td>
									<a class="btn btn-sm btn-success" href="index.php?controller=exercises&amp;action=view&amp;exerciseId=<?=$exercise->getExerciseId()?>"><?=i18n("View")?></a>
									<a class="btn btn-sm btn-primary" href="index.php?controller=exercises&amp;action=edit&amp;exerciseId=<?=$exercise->getExerciseId()?>"><?=i18n("Modify")?></a>
									<form id="<?=$exercise->getExerciseId()?>"  method="POST" action="index.php?controller=exercises&amp;action=delete&amp;exerciseId=<?=$exercise->getExerciseId()?>">
